...
import "package:quizui/data/describe_chatgpt.dart";

class GptEasy extends StatefulWidget {
  const GptEasy({Key? key}) : super(key: key);
  @override
  State<GptEasy> createState() => _MyAppState();
}

class _MyAppState extends State<GptEasy> {
  bool isVisible = false;
  bool fav = false;
  final fieldText = TextEditingController();
  List<GPT> questionList = getQuestions();
            ...
            Container(
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  Text(
                    questionList[currentOneIndex].answerText,
