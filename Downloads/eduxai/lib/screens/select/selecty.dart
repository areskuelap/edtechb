...
import "package:quizui/screens/select/selectz.dart";
...
class Selecty extends StatefulWidget {
  const Selecty({Key? key}) : super(key: key);

  @override
  State<Selecty> createState() => _MyAppState();
}

class _MyAppState extends State<Selecty> {
  @override
                  ...
                  child: ElevatedButton(
                    ...
                    onPressed: () {
                      Navigator.of(context).push(
                          MaterialPageRoute(builder: (context) => Selectz()));
                    },
                    style: ButtonStyle(
                      backgroundColor: MaterialStateProperty.all(
                        Color(0xfff9930d),
