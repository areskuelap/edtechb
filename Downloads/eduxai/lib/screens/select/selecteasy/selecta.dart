...
import "package:quizui/screens/select/selecteasy/selectb.dart";
...
class Selectas extends StatefulWidget {
  const Selectas({Key? key}) : super(key: key);

  @override
  State<Selectas> createState() => _MyAppState();
}

class _MyAppState extends State<Selectas> {
  @override
