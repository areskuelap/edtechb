...
import "package:quizui/screens/select/selectq.dart";
...
class Selectp extends StatefulWidget {
  const Selectp({Key? key}) : super(key: key);

  @override
  State<Selectp> createState() => _MyAppState();
}

class _MyAppState extends State<Selectp> {
  @override
                  ...
                  child: ElevatedButton(
                    ...
                    onPressed: () {
                      Navigator.of(context).push(
                          MaterialPageRoute(builder: (context) => Selectq()));
                    },
                    style: ButtonStyle(
                      backgroundColor: MaterialStateProperty.all(
                        Color(0xfff9930d),
