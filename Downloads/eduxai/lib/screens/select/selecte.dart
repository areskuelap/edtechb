...
import "package:quizui/screens/select/selectf.dart";
...
class Selecte extends StatefulWidget {
  ...
  @override
  State<Selecte> createState() => _MyAppState();
}

class _MyAppState extends State<Selecte> {
  @override
                  ...
                  child: ElevatedButton(
                    ...
                    onPressed: () {
                      Navigator.of(context).push(
                          MaterialPageRoute(builder: (context) => Selectf()));
                    },
                    style: ButtonStyle(
                      backgroundColor: MaterialStateProperty.all(
                        Color(0xfff9930d),
