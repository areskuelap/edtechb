...
import "package:quizui/screens/select/selectk.dart";
...
class Selectj extends StatefulWidget {
  const Selectj({Key? key}) : super(key: key);

  @override
  State<Selectj> createState() => _MyAppState();
}

class _MyAppState extends State<Selectj> {
  @override
                  ...
                  child: ElevatedButton(
                    ...
                    onPressed: () {
                      Navigator.of(context).push(
                          MaterialPageRoute(builder: (context) => Selectk()));
                    },
                    style: ButtonStyle(
                      backgroundColor: MaterialStateProperty.all(
                        Color(0xfff9930d),
