...
import "package:quizui/screens/select/selectmedium/selecto.dart";
...
class Selectn extends StatefulWidget {
  const Selectn({Key? key}) : super(key: key);

  @override
  State<Selectn> createState() => _MyAppState();
}

class _MyAppState extends State<Selectn> {
  @override
                  ...
                  child: ElevatedButton(
                    ...
                    onPressed: () {
                      Navigator.of(context).push(
                          MaterialPageRoute(builder: (context) => Selecto()));
                    },
                    style: ButtonStyle(
                      backgroundColor: MaterialStateProperty.all(
                        Color(0xfff9930d),
