...
import "package:quizui/screens/select/selectmedium/selectb.dart";
...
class Selecta extends StatefulWidget {
  const Selecta({Key? key}) : super(key: key);

  @override
  State<Selecta> createState() => _MyAppState();
}

class _MyAppState extends State<Selecta> {
  @override
                  ...
                  child: ElevatedButton(
                    ...
                    onPressed: () {
                      Navigator.of(context).push(
                          MaterialPageRoute(builder: (context) => Selectb()));
                    },
                    style: ButtonStyle(
                      backgroundColor: MaterialStateProperty.all(
                        Color(0xfff9930d),
