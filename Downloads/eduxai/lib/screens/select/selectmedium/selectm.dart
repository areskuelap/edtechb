...
import "package:quizui/screens/select/selectmedium/selectn.dart";
...
class Selectm extends StatefulWidget {
  const Selectm({Key? key}) : super(key: key);

  @override
  State<Selectm> createState() => _MyAppState();
}

class _MyAppState extends State<Selectm> {
  @override
                  ...
                  child: ElevatedButton(
                    ...
                    onPressed: () {
                      Navigator.of(context).push(
                          MaterialPageRoute(builder: (context) => Selectn()));
                    },
                    style: ButtonStyle(
                      backgroundColor: MaterialStateProperty.all(
                        Color(0xfff9930d),
