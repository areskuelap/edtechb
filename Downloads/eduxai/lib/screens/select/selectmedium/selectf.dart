...
import "package:quizui/screens/select/selectmedium/selectg.dart";
...
class Selectf extends StatefulWidget {
  const Selectf({Key? key}) : super(key: key);

  @override
  State<Selectf> createState() => _MyAppState();
}

class _MyAppState extends State<Selectf> {
  @override
                  ...
                  child: ElevatedButton(
                    ...
                    onPressed: () {
                      Navigator.of(context).push(
                          MaterialPageRoute(builder: (context) => Selectg()));
                    },
                    style: ButtonStyle(
                      backgroundColor: MaterialStateProperty.all(
                        Color(0xfff9930d),
