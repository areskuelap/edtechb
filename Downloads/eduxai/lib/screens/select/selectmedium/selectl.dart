...
import "package:quizui/screens/select/selectmedium/selectm.dart";
...
class Selectl extends StatefulWidget {
  const Selectl({Key? key}) : super(key: key);

  @override
  State<Selectl> createState() => _MyAppState();
}

class _MyAppState extends State<Selectl> {
  @override
                  ...
                  child: ElevatedButton(
                    ...
                    onPressed: () {
                      Navigator.of(context).push(
                          MaterialPageRoute(builder: (context) => Selectm()));
                    },
                    style: ButtonStyle(
                      backgroundColor: MaterialStateProperty.all(
                        Color(0xfff9930d),
