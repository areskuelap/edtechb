...
import "package:quizui/screens/select/selecty.dart";
...
class Selectx extends StatefulWidget {
  const Selectx({Key? key}) : super(key: key);

  @override
  State<Selectx> createState() => _MyAppState();
}

class _MyAppState extends State<Selectx> {
  @override
                  ...
                  child: ElevatedButton(
                    ...
                    onPressed: () {
                      Navigator.of(context).push(
                          MaterialPageRoute(builder: (context) => Selecty()));
                    },
                    style: ButtonStyle(
                      backgroundColor: MaterialStateProperty.all(
                        Color(0xfff9930d),
