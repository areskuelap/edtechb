...
class NextGpt extends StatefulWidget {
  const NextGpt({Key? key}) : super(key: key);
  _WidgetState createState() => _WidgetState();
}

class _WidgetState extends State<NextGpt> {
  @override
          ...
          children: <Widget>[
                ...
                child: ElevatedButton.icon(
                  ...
                  onPressed: () {
                    Navigator.of(context).push(
                        MaterialPageRoute(builder: (context) => GptEasy()));
                  },
            ...
            Container(
                ...
                child: ElevatedButton.icon(
                  ...
                  onPressed: () {
                    Navigator.of(context).push(
                        MaterialPageRoute(builder: (context) => GptHard()));
                  },
                  icon: Icon(Icons
