class Speak {
  ...
  Speak(this.questionText, this.answerText);
}

List<Speak> getQuestions() {
  List<Speak> list = []; //ADD questions and answer here
  ...
  list.add(Speak(
      "Modern education increasingly makes use of new technology. What are the benefits of this novel technique?",
  ...
  list.add(Speak(
      "Many old structures are being demolished or replaced. What might be the possible reasons for this?",
      "The lack of land availability is one of the main causes of historic structures being demolished. More land is required to accommodate houses for the growing population as the world's population is rising. Furthermore, urbanisation is replacing a lot of old buildings. Numerous businesses have been able to annex historic structures in the name of development due to the rapid spread of urbanisation. As a result, as people become oblivious to the changes occurring around them, the value of ancient structures is steadily declining."));

  list.add(Speak("How would you describe your home?",
      "My home is an apartment, not a house. It is a ten-story structure with five apartments on each floor and a total of forty apartments. It is situated in a city and on a very crowded street. | have lived here all my life, and this flat is where | met most of my friends and did group study. We all went to the same elementary school and have maintained close relationships over the years. I have some of the most lovely moments in my life with this house and the little things I used to decorate it."));

  list.add(Speak(
      "Compared to private transportation, public transportation reduces pollution and costs. Which one do you prefer and why?",
      "Personally, I agree entirely with this assertion. The cost of public transportation is lower than that of private transportation Personally, I make use of it every day. However, even though they reduce pollution compared to private transportation, there is no denying the convenience and comfort of having a private vehicle. Owning a private vehicle is an absolute luxury and privilege. However, for large groups of people, public transportation is unquestionably the superior choice"));

  list.add(Speak(
      "While some people contend that the government should fund space technology, others claim that the government should construct hospitals. Which stance do you agree with?",
      "In my opinion, government expenditure on hospitals should always take precedence over funding for space technology. I think there is much potential for human civilisation in space research. it is a luxury, though, for a growing nation like ours. Building quality hospitals is one of the key elements to achieving the improved health care systems that our nation so desperately needs. Although it is perfectly acceptable for the government to invest money in space exploration, it is not acceptable for it to do so at the price of the well-being of its people."));
