...
import "package:quizui/screens/select/selectv.dart";
...
class Selectu extends StatefulWidget {
  const Selectu({Key? key}) : super(key: key);

  @override
  State<Selectu> createState() => _MyAppState();
}

class _MyAppState extends State<Selectu> {
  @override
                  ...
                  child: ElevatedButton(
                    ...
                    onPressed: () {
                      Navigator.of(context).push(
                          MaterialPageRoute(builder: (context) => Selectv()));
                    },
                    style: ButtonStyle(
                      backgroundColor: MaterialStateProperty.all(
                        Color(0xfff9930d),
