...
import "package:quizui/screens/select/selectmedium/selectr.dart";
...
class Selectq extends StatefulWidget {
  const Selectq({Key? key}) : super(key: key);

  @override
  State<Selectq> createState() => _MyAppState();
}

class _MyAppState extends State<Selectq> {
  @override
                  ...
                  child: ElevatedButton(
                    ...
                    onPressed: () {
                      Navigator.of(context).push(
                          MaterialPageRoute(builder: (context) => Selectr()));
                    },
                    style: ButtonStyle(
                      backgroundColor: MaterialStateProperty.all(
                        Color(0xfff9930d),
