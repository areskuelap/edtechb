...
import "package:quizui/screens/select/selectmedium/selects.dart";
...
class Selectr extends StatefulWidget {
  const Selectr({Key? key}) : super(key: key);

  @override
  State<Selectr> createState() => _MyAppState();
}

class _MyAppState extends State<Selectr> {
  @override
                  ...
                  child: ElevatedButton(
                    ...
                    onPressed: () {
                      Navigator.of(context).push(
                          MaterialPageRoute(builder: (context) => Selects()));
                    },
                    style: ButtonStyle(
                      backgroundColor: MaterialStateProperty.all(
                        Color(0xfff9930d),
