...
import "package:quizui/screens/select/selecti.dart";
...
class Selecth extends StatefulWidget {
  const Selecth({Key? key}) : super(key: key);

  @override
  State<Selecth> createState() => _MyAppState();
}

class _MyAppState extends State<Selecth> {
  @override
                  ...
                  child: ElevatedButton(
                    ...
                    onPressed: () {
                      Navigator.of(context).push(
                          MaterialPageRoute(builder: (context) => Selecti()));
                    },
                    style: ButtonStyle(
                      backgroundColor: MaterialStateProperty.all(
                        Color(0xfff9930d),
