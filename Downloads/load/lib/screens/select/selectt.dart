...
import "package:quizui/screens/select/selectu.dart";
...
class Selectt extends StatefulWidget {
  const Selectt({Key? key}) : super(key: key);

  @override
  State<Selectt> createState() => _MyAppState();
}

class _MyAppState extends State<Selectt> {
  @override
                  ...
                  child: ElevatedButton(
                    ...
                    onPressed: () {
                      Navigator.of(context).push(
                          MaterialPageRoute(builder: (context) => Selectu()));
                    },
                    style: ButtonStyle(
                      backgroundColor: MaterialStateProperty.all(
                        Color(0xfff9930d),
