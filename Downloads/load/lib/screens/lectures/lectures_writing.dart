...
class LecturesWriting extends StatefulWidget {
  @override
  _VideoPlayerScreenState createState() => _VideoPlayerScreenState();
}

class _VideoPlayerScreenState extends State<LecturesWriting> {
      ...
      body: Column(
        children: [
          ...
          DropdownButton<String>(
            ...
            items: _videoUrls.asMap().entries.map<DropdownMenuItem<String>>((entry) {
