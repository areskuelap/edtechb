...
import "package:quizui/data/reading_hard_data.dart";
import 'dart:async';

class ReadingHard extends StatefulWidget {
  const ReadingHard({Key? key}) : super(key: key);
  @override
  State<ReadingHard> createState() => _MyAppState();
}

class _MyAppState extends State<ReadingHard> {
  Timer? _timer;
  int _seconds = 0;
