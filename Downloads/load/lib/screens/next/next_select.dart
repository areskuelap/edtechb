...
import "package:quizui/screens/lectures/lectures_select.dart";

class NextSelect extends StatefulWidget {
  @override
  State<NextSelect> createState() => _CustomEdtechWidgetState();
}

class _CustomEdtechWidgetState extends State<NextSelect> {
  @override
  ...
  void onLecturesTap(BuildContext context) {
    Navigator.of(context).push(MaterialPageRoute(
        builder: (context) =>
            LecturesSelect())); // Implement your onTap method for the Lectures section
  }
          ...
          ListTile(
            ...
            onTap: () {
              Navigator.of(context)
                  .push(MaterialPageRoute(builder: (context) => SelectaEasy()));
            },
          ),
          ListTile(
            leading: Icon(Icons.arrow_right),
            ...
            onTap: () {
              Navigator.of(context).push(
                  MaterialPageRoute(builder: (context) => SelectMedium()));
            },
          ),
          ListTile(
            leading: Icon(Icons.arrow_right),
