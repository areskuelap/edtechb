...
import "package:quizui/screens/lectures/lectures_listening.dart";
import "package:quizui/screens/docs/docs_listening.dart";

class NextListening extends StatefulWidget {
  @override
  State<NextListening> createState() => _CustomEdtechWidgetState();
}

class _CustomEdtechWidgetState extends State<NextListening> {
  @override
  ...
  void onLecturesTap(BuildContext context) {
    Navigator.of(context).push(MaterialPageRoute(
        builder: (context) =>
            LecturesListening())); // I    // Implement your onTap method for the Lectures section
  }
          ...
          ListTile(
            ...
            onTap: () {
              Navigator.of(context)
                  .push(MaterialPageRoute(builder: (context) => Listening()));
            },
          ),
          ListTile(
            leading: Icon(Icons.arrow_right),
            ...
            onTap: () {
              Navigator.of(context).push(
                  MaterialPageRoute(builder: (context) => ListeningMedium()));
            },
          ),
          ListTile(
            leading: Icon(Icons.arrow_right),
            ...
            onTap: () {
              Navigator.of(context).push(
                  MaterialPageRoute(builder: (context) => ListeningHard()));
            },
          ),
        ],
      ),
    ...
    Navigator.push(
      ...
      MaterialPageRoute(
        builder: (context) => PDFViewerPage(
            url:
                'https://luya.blob.core.windows.net/test/12,+YT,+DET+Sample+Test.pdf'),
      ),
    );
