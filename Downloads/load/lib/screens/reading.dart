...
import "package:quizui/data/reading_data.dart";
import 'dart:async';

class Reading extends StatefulWidget {
  const Reading({Key? key}) : super(key: key);
  @override
  State<Reading> createState() => _MyAppState();
}

class _MyAppState extends State<Reading> {
  Timer? _timer;
  int _seconds = 0;
  int _progressBarDuration = 300; // 4 minutes in seconds
